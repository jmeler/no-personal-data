...
const translations = {
  ...
  eu: {
    title: "Datu pertsonalen pseudonimizatzailea",
    subtitle: "Nabigatzailean bertan prozesatua. Ez da daturik bidaltzen zerbitzarira.",
    validation: "Egiaztatua <a target=\"_blank\" rel=\"noopener noreferrer\" referrerpolicy=\"no-referrer\" href=\"https://web.gencat.cat/content/webgencat/ca/generalitat/com-ens-organitzem/adreces-i-telefons/detall-adreces-i-telefons.html?objectID=16415\">Hezkuntza Teknologien eta Digitalizazio Arduratsuaren Arloak</a>, Kataluniako Hezkuntza eta Lanbide Heziketako Departamentua.",
    languageLabel: "Hizkuntza",
    outputFormatLabel: "Irteerako formatua",
    step1: "Kargatu datu guztiak dituen kalkulu-orria",
    uploadTitle: "Arrastatu fitxategia hona",
    uploadHint: "edo egin klik hautatzeko",
    uploadFormats: "Formatuak: CSV, XLSX, XLS, ODS, PDF",
    csvHint: "CSV: bereizlea ',' edo ';' eta hamarrenak puntuz (.).",
    sheetLabel: "Orria (sheet):",
    step2: "Jatorrizko dokumentuaren aurrebista",
    step3: "Hautatu pseudonimizatu beharreko eremuak",
    step4: "Sortu eta deskargatu",
    step5: "Emaitzaren aurrebista eta deskarga",
    privateTitle: "Orri pribatua",
    privateHint: "Datu pertsonalak ditu. Ez partekatu lineako biltegietan edo IA-rekin.",
    publicTitle: "Orri publikoa",
    publicHint: "Publikoki erabil daiteke.",
    download: "Deskargatu",
    generate: "Fitxategiak sortu",
    previewEmpty: "Ez dago erakusteko errenkadarik.",
    previewCount: "{count} erakusten, guztira {total}.",
    statusSheetEmpty: "Orri honek ez du daturik.",
    statusNoData: "Ez dago kargatutako daturik.",
    statusSelectColumn: "Hautatu gutxienez zutabe bat pseudonimizatzeko.",
    statusMissingColumns: "Ez dira aurkitu zutabeak: {cols}",
    statusGenerated: "Fitxategiak sortuta. Orain deskarga ditzakezu.",
    statusUnsupported: "Formatua ez da onartzen. Kargatu CSV, XLSX, XLS, ODS edo PDF.",
    statusReadError: "Errorea fitxategia irakurtzean: {err}"
  },
  en: {
